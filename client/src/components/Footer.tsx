...
const Footer = () => {
  ...
  const XIcon = () => (
    ...
    >
      <path
        fill="#90A1B9"
        d="M714.163 519.284L1160.89 0H1050.24L668.408 442.64 369.23 0H0l463.94 681.478L0 1226.37h110.65l404.77-476.7 
         319.393 476.7H1200L714.163 519.284ZM560.292 687.293l-46.774-67.486L150.38 80h157.07l303.02 437.774 
         46.774 67.487L1045.61 1147h-157.07L560.292 687.293Z"
      />
    </svg>
  );
  ...
  return (
    <footer className="mx-6 bg-gradient-to-b from-slate-50 to-white">
